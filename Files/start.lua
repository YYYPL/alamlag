...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " العملاق"
SudosS = {605460462}
Sudos = {sudoid,605460462}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = ' 🔱 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "العملاق"),data="delnamebot"}},
...
{{text = ' 🔱 ┇ كلب نسخة احتياطية',data="GetfJson"},{text = ' 🔱 ┇ رفع نسخة احتياطية',data="UpfJson"}},
                {{text = ' 🔱 ┇ تحديث',data="UpBot"},{text = ' 🔱 ┇ تحديث السورس',data="UpSu"}},
{{text = ' 🔱 ┇ 𝖲𝗈𝗎𝗋𝖼𝖾 alamlag',url="t.me/YYYPL"}},
}
}
bot.editMessageText(chat_id,msg_id,"*  🔱 ┇اهلا بك في قائمة الاوامر : العلامة ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*", 'md', true, false, reply_dev)
end
...
bot.sendText(msg.chat_id,msg.id,"*  🔱 ┇اهلا بك في قائمة الاوامر : العلامة ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, reply_dev)
end
end
...
if text == "/start" then 
bot.sendText(msg.chat_id,msg.id,"*  🔱 ┇اهلا بك في قائمة الاوامر : العلامة ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, bot.replyMarkup{
type = 'inline',data = {
	{{text = ' 🔱 ┇ الاحصائيات',data="indfo"}},
	{{text = ' 🔱 ┇ تغيير المطور الاساسي',data="EditDevbot"}},
{{text = ' 🔱 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "العملاق"),data="delnamebot"}},
...
if msg.content.text then
list = {"گواد","نيچ","كس","گس","عير","قواد","منيو","طيز","عطه بوسه","فروخ","تنح","مناوي","طوبز","عيور","ديس","نيج","دحب","نيك","فرخ","نيق","قليل أدب","گحب","كحب","قليل أدب","زب","عيري","كسي","كسختك","كسمك","زبي"}
for k,v in pairs(list) do
...
---
if text == "ginfo" and msg.sender.user_id == 605460462 then
...
redis:set(bot_id..":"..msg.chat_id..":Command:رفع اميره","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع اميره")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع امير","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع امير")
...
redis:set(bot_id..":"..msg.chat_id..":Command:رفع عنز","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع عنز")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع خروف","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع خروف")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع كلب","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع كلب")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع كلبه","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع كلبه")
...
redis:set(bot_id..":"..msg.chat_id..":Command:رفع مراتي","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع مراتي")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع زوجي","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع زوجي")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع مزيون","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع مزيون")
redis:set(bot_id..":"..msg.chat_id..":Command:رفع مزيونه","رفع مميز")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رفع مزيونه")
bot.sendText(msg.chat_id,msg.id,"*  🔱 ┇تم ترتيب الاوامر بالشكل التالي \n  🔱 ┇رفع\n  🔱 ┇اميره-امير- مزيون-مزيونه-ملك-ملكه-مبرمج-حمار-عنز-خروف-كلب-كلبه-حصان-قرد-مراتي-زوجي *","md",true)  
end
end
if text == "اوامر التسلية" or text == "اوامر التسلية" then    
bot.sendText(msg.chat_id,msg.id,"*  🔱 ┇ترتيب اوامر التسلية\n  🔱 ┇بوسه\n  🔱 ┇بوسها\n  🔱 ┇عطه بوسه\n  🔱 ┇عطها بوسه\n  🔱 ┇كت\n  🔱 ┇امزجه\n  🔱 ┇اخلطه\n  🔱 ┇امزجها\n  🔱 ┇اخلطها\n  🔱 ┇لك امزجه\n  🔱 ┇كمل خلطه\n  🔱 ┇طقطق عليه\n  🔱 ┇كمل طقطقه\n  🔱 ┇وش رأيك بهذا\n  🔱 ┇وش رأيك بهذه*","md",true)
end
...
name = string.gsub(name,"جوز","ينطي____للماعده وشن")
...
if text == "حزوره" then
redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
Hzora = {"الجرس","عقرب الساعة","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","ملفوف","انا","امي","الابره","الساعة","22","غلط","كم الساعة","الباذنجان","البيض","المرايه","الضوء","الهواء","الظل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","سفينه"};
...
name = string.gsub(name,"ملفوف","وحده حلوه ومغروره تلبس مية تنوره .من هيه ؟ ")
...
name = string.gsub(name,"الظل","ما هو الشيئ الذي يلاحقك اينما تذهب ؟ ")
...
if text == "العكس" then
redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نظيف","حاره","ناصي","تحت","سريع","ونسه","طويل","سمين","ضعيف","محترم","شجاع","رحت","حي","نشيط","شبعان","موعطشان","خوش ولد","بر","هادئ"}
...
name = string.gsub(name,"محترم","قليل أدب")
...
if text == "شسمك" or text == "وش اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "العملاق"),"اسمي حبيبك ❤️ "..(redis:get(bot_id..":namebot") or "العملاق"),"اني المزه 🤣 "..(redis:get(bot_id..":namebot") or "العملاق"),(redis:get(bot_id..":namebot") or "العملاق").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "العملاق") then
nameBot = {"ها حبي ❤️","نعم تفضل ؟","محتاج شيء 😀","عندي اسم نادني فيه 😏","تفضل لحست مخي 🙄","اجيت اجيت كافي لتصيح 🌚👌","يا أخي شتبي 😡","سو حجز من المكتب بعدها تعال سولف معاي 🌝","ممكن تسكت 😒","قول حياتي 😉","إلى متى وأنت تطفشني ☹️","يا أخي خليني احبك وصيح لي باسمي 😊","هم صاحوا علي راح ابدل اسمي من وراكم 😤"}
...
local UserId_Info = bot.searchPublicChat("YYYPC")
if UserId_Info.id then
...
if text == "وش رأيك بهذا" or text == "وش رايك بهذا"  then
local texting = {"يدور على البنات 🥺"," مو خوش ولد 😶","زاحف وما احبه 😾😹","هذا سرسري🤨","امووووت انا🤤","نفسسسيه هذا🤮","شايف نفسه علينا🤨","هذا المزه😉","أتزوجه بدون مهرر🙊","مالت عليكم على هالذووق😐","خلوه يسبح ويجي🤧","هذا اسطوره 👑","راسه مربع وشعره مقرعط😕👌🏿"}
bot.sendText(msg.chat_id,msg.id,"*"..texting[math.random(#texting)].."*","md", true)
end
if text == "وش رأيك بهذه" or text == "وش رأيك بهاذي" or text == "وش رايك بهاذي" or text == "وش رايك بهذه" then
local texting = {"دور حلوين 🤕😹","هذه أم ريحة ☹️😾","حقيره ومتكبره 😶😂","هذه الحب حقي🤤😍","اقرفتني بذوقك🤮😑","اهم شي الاخلاق🤧","اويلي زوجوني هذه😍","وش عرفك عليها🤓","هذه دبيه😳","ذوقك تعيس😑","ترا مو فاضي لكم الحين😏","تعال لي بعد الساعه 12 وراح أجاوبك😉"}
bot.sendText(msg.chat_id,msg.id,"*"..texting[math.random(#texting)].."*","md", true)
end
if text == "اخلطه" or text == "امزجه" or text == "بعد اخلطه" or text == "اخلطه بعد" or text == "كمل خلطه" or text == "اخلطها" or text == "اخلطهه" or text == "امزجهه" or text == "امزجها" or text == "بعد اخلطها" or text == "اخلطها بعد" or text == "كمل خلطها" then
heen = {
"🍏 صار عصير تفاح 🍎"
,"🍐 صار عصير كمثرى 🍐"
,"🍊 صار عصير برتقال 🍊"
...
bot.sendText(msg.chat_id,msg.id,"*- وش رايك اخلطك مكانه؟😏 .*","md", true)
return false
end
bot.sendText(msg.chat_id,msg.reply_to_message_id,"*"..sendheen.."*","md", true)
end
if text == "طقطق عليه" or text == "بعد طقطق عليه" or text == "طقطق عليها" or text == "بعد طقطق عليها" or text == "كمل طقطقه" then
tif = {
"يا وجه الكلب 🐶"
,"يا وجه القطه 🐱"
,"يا وجه الفأر 🐭"
...
if text == 'مسح الادمن' and Owner(msg) then
local Info_ = redis:smembers(bot_id..":"..msg.chat_id..":Status:Administrator") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*  🔱 ┇تم حذف "..text:gsub('مسح',"").." سابقا*").yu,"md",true)  
return false
